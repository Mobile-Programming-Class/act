package com.allam.act.api.json.response
...
data class Weather(
    ...
    val daily: MutableList<DailyItem?>? = null,

    @field:SerializedName("lon")
    val lon: Double? = null,

    @field:SerializedName("hourly")
    val hourly: MutableList<HourlyItem?>? = null,

    @field:SerializedName("minutely")
    val minutely: MutableList<MinutelyItem?>? = null,
